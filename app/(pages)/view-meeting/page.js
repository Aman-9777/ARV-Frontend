...
const ViewMeeting = () => {
    ...
    const handleUpdate = async () => {
        try {
            ...
            const response = await updateMeeting(editMeeting.meetingId, meetingData, authToken);
    ...
    return (
        <div className="body flex-grow-1 px-3">
            <div className="container-lg">
                                        ...
                                        <tbody>
                                            {meetings.map((meeting, index) => (
                                                <tr key={index}>
                                                    ...
                                                    <td>
                                                        <button type="button" data-bs-toggle="modal" data-bs-target="#updateMeeting" className='btn' onClick={() => handleEdit(meeting)}>
             ...
             {/* Edit Modal */}
        <div className="modal fade" id="updateMeeting" aria-labelledby="updateMeetingLabel" aria-hidden="true">
            <div className="modal-dialog">
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title" id="updateMeetingLabel">Update Meeting</h5>
                    ...
                    <div className="modal-body">
                        <form>
                            <div className="mb-3">
                                ...
                                <input type="date" className="form-control" id="meetingDate" name="meetingDate" value={editMeeting.meetingDate} onChange={handleChange} />
                            </div>

                            <div className="mb-3">
                                <label htmlFor="startTime" className="form-label">Start Time</label>
                                <input type="time" className="form-control" id="startTime" name="startTime" value={editMeeting.startTime} onChange={handleChange} />
                            </div>
                            <div className="mb-3">
                                <label htmlFor="endTime" className="form-label">End Time</label>
                                <input type="time" className="form-control" id="endTime" name="endTime" value={editMeeting.endTime} onChange={handleChange} />
                            </div>
                        </form>
                    </div>
